...
<Preview>
  <Story
    name="Secondary/default button (inverse)"
    parameters={{ styles: [Promise.resolve(require('./_stories.scss'))] }}
  >
...
<Preview>
  <Story
    name="Secondary/default button (mono)"
    parameters={{ styles: [Promise.resolve(require('./_stories.scss'))] }}
  >
...
<Preview>
  <Story name="B2C theme" parameters={{ styles: [Promise.resolve(require('./_stories.scss'))] }}>
...
<Preview>
  <Story name="Icon buttons" parameters={{ styles: [Promise.resolve(require('./_stories.scss'))] }}>
    <div>
