...
Shows who won wa race.

<Preview>
  <Story name="Various permutations (Large)">
    <div style={{ width: '100%' }}>
...
<Preview>
  <Story name="Various permutations (Small)">
    <div style={{ width: '100%' }}>
...
Party names longer than 20 letter long default to their shortname

<Preview>
  <Story name="Scottish National Party will always be SNP">
    <div style={{ width: '100%' }}>
      <ul>
        <li>
          S breakpoint:{' '}
